...
if __name__ == "__main__":
    ...
    # Необходимо написать программу, которая считывает список слов из файла и собирает
    # статистику о том, в каком проценте слов используется каждая буква алфавита.
    # Необходимо вывести результат для всех слов и отметить ту, которая встречалась в
    # словах наиболее редко. Знаки препинания и регистр букв должны игнорироваться (Вариант 26 (11))
